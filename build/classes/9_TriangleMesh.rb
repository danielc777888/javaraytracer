        ...
        triangle12.setV1(Vector3D.new(0.0,0.0,300.0))
				...
				sm = Matrix::multiply(rm,Matrix::createScalingMatrix(triangle.getV1(),2.0,2.0,2.0))
								puts cube.getMatrix
				cube.setMatrix(sm)
					puts cube.getMatrix
				cube.transform
				...
				puts cube2.getMatrix
		
				tm = Matrix::multiply(cube2.getMatrix,Matrix.createTranslationMatrix(-100,0,0))
				cube2.setMatrix(tm)
				cube2.transform
